...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark" style="background-color: #8B008B;">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="https://twitter.com/thedataprof" target="_blank">Técnicos</a>
      </li>
    </ul>
  </div>
</nav>
...
weekly_data= df["Dia"].unique()
chart_data = pd.DataFrame(weekly_data[:40],         columns=df["Tipo"].unique() )
